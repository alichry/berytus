...
export class XPPromptServiceChildProxy {
    async promptUsingPopupNotification(innerWindow, args_webAppCryptoActor, args_accountConstraints_category, args_accountConstraints_schemaVersion, args_accountConstraints_identity) {

...
import type { IExchangeKeyGenerator, IExchangeKeyLoader, KeyPairMaterial } from "./types";

const { subtle } = globalThis.crypto;

export class X25519KeyComposer implements IExchangeKeyGenerator,
    IExchangeKeyLoader {
    ...
    async importPrivateKey(
        privateKeyMaterial: KeyPairMaterial["privateKey"]
    ): Promise<CryptoKey> {
